        ...
        <div className="grid md:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <article key={post.id} className="group">
              <div className="relative overflow-hidden bg-white/80 backdrop-blur-md rounded-2xl mb-4 border-2 border-primary/20 shadow-lg hover:bg-gradient-to-br hover:from-primary hover:to-primary/80 hover:border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="absolute top-4 left-4 bg-primary text-white rounded-lg p-3 text-center min-w-[60px] shadow-lg group-hover:bg-white group-hover:text-primary transition-all duration-300">
              ...
              <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 border-2 border-primary/20 shadow-lg hover:bg-gradient-to-br hover:from-primary hover:to-primary/80 hover:border-white/20 transition-all duration-300 group">
