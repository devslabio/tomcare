        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="#donate"
                className="inline-flex items-center justify-center gap-2 bg-accent text-accent-foreground px-8 py-4 rounded-lg hover:opacity-90 transition-colors duration-200 font-semibold text-lg"
              >
                Donate Now
              ...
              <Link
                href="#volunteer"
                className="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white/10 transition-colors duration-200 font-semibold text-lg"
              >
                Become a Volunteer
              </Link>
            </div>
          ...
          <div className="relative hidden md:block">
            <div className="bg-white/10 backdrop-blur rounded-xl p-8 space-y-4">
              <div className="bg-accent/20 h-64 rounded-lg flex items-center justify-center text-accent">
